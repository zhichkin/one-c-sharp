...
{
    public partial class PublisherAgent : ServiceBase
    {
        ...
        private const string CONST_ServiceName = "Z-Integrator Publisher Service";
        ...
        private string GetSuccessText(Publisher publisher, int messagesSent)
        {
            return string.Format("Publisher \"{0}\": {1} messages sent.",
                publisher.Name,
