...
{
    public class ParameterViewModel : BindableBase, IParameter
    {
        ...
        public ParameterViewModel(QueryViewModel query) { _Query = query; }
        
        public QueryViewModel Query { get { return _Query; } }
        public string Name
        {
            get { return _Name; }
            set
